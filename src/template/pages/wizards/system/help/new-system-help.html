<div class="tooltip-definitions" style="display: none;">
    <div data-tooltip-id="system-name">
        ...
        <div>
            <h3>Was ist ein IT-System?</h3>
            Eine Sammlung von zusammengehörigen Komponenten (Server, Datenbanken, Software), die gemeinsam eine Funktion erfüllen.
        </div>
        <div>
    ...
    <div data-tooltip-id="version">
        ...
        <div>
            <h3>Beispiele:</h3>
            <ul>
                <li>2024.1, 8.2.5, v12.3, Release 2023 Q4</li>
            </ul>
        </div>
    ...
    <div data-tooltip-id="data-classification">
        <h2>Datenschutz-Klassifizierung</h2>
    ...
    <div data-tooltip-id="last-audit">
        <h2>Letzte Sicherheitsüberprüfung</h2>
        <p>Wann wurde das System zuletzt auf Sicherheit geprüft?</p>
        <div>
            <h3>Arten von Prüfungen:</h3>
            <ul>
    ...
    <div data-tooltip-id="it-components">
        <h2>Zugehörige IT-Objekte</h2>
        <p>Aus welchen technischen Komponenten besteht das System?</p>
        <div>
            <h3>Was Sie hier dokumentieren:</h3>
            <ul>
