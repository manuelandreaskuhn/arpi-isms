<div class="tooltip-definitions" style="display: none;">
    ...
    <div data-tooltip-id="interface-type">
        ...
        <div>
            <h3>Entscheidung:</h3>
            Meist vom Quell- und Zielsystem vorgegeben!
        </div>
    </div>

    <div data-tooltip-id="data-direction">
        <h2>Datenflussrichtung</h2>
        <p>In welche Richtung fließen die Daten?</p>
        <div>
            <h3>Richtungen erklärt:</h3>
            <ul>
        ...
        <div>
            <h3>Perspektive:</h3>
            Immer aus Sicht des Systems, das Sie gerade dokumentieren!
        </div>
    ...
    <div data-tooltip-id="source-system">
        ...
        <div>
            <h3>Bei ausgehend:</h3>
            Das ist das System, das Sie gerade dokumentieren
        </div>
        <div>
            <h3>Bei eingehend:</h3>
            Das ist das externe System
        </div>
    </div>

    <div data-tooltip-id="source-component">
        <h2>Quell-Komponente</h2>
        <p>Die konkrete VM oder der Server, auf dem das Quellsystem läuft (optional).</p>
        <div>
            <h3>Warum hilfreich?</h3>
            <ul>
        ...
        <div>
            <h3>Beispiel:</h3>
            KIS läuft auf "kis-app-server-01" → Diese VM auswählen
        </div>
    ...
    <div data-tooltip-id="direct-port">
        <h2>Port (Direkte Verbindung)</h2>
        <p>Der TCP-Port, auf dem das Zielsystem lauscht.</p>
        <div>
            <h3>Typische HL7-Ports:</h3>
            <ul>
    ...
    <div data-tooltip-id="direct-encryption">
        <h2>Verschlüsselung (Direkte Verbindung)</h2>
    ...
    <div data-tooltip-id="commserver-select">
        <h2>Kommunikationsserver auswählen</h2>
        <p>Wählen Sie einen bestehenden Interface Engine oder geben Sie manuell ein.</p>
        <div>
            <h3>Was ist eine Interface Engine?</h3>
            Zentrale Software, die Nachrichten zwischen Systemen vermittelt, transformiert und routet.
        </div>
        <div>
            <h3>Vorteile:</h3>
            <ul>
    ...
    <div data-tooltip-id="commserver-channel">
        <h2>Channel / Route Name</h2>
        <p>Der Name des Channels oder der Route auf dem Kommunikationsserver.</p>
        <div>
            <h3>Was ist ein Channel?</h3>
            Eine konfigurierte Schnittstellen-Verbindung in der Interface Engine - definiert Quelle, Ziel, Transformation.
        </div>
        <div>
            <h3>Beispiele:</h3>
            <ul>
    ...
    <div data-tooltip-id="fileshare-protocol">
        ...
        <div>
            <h3>Empfehlung:</h3>
            SFTP für externe Verbindungen, SMB/NFS intern
        </div>
    </div>

    <div data-tooltip-id="file-pattern">
        <h2>Dateiformat / -muster</h2>
    ...
    <div data-tooltip-id="mq-system">
        ...
        <div>
            <h3>Was ist eine Message Queue?</h3>
            Eine Warteschlange für Nachrichten - wie ein Postfach, das Nachrichten zwischenspeichert.
        </div>
        <div>
            <h3>Systeme:</h3>
            <ul>
    ...
    <div data-tooltip-id="target-component">
        <h2>Ziel-Komponente</h2>
        <p>Die konkrete Komponente (Load Balancer, VM, Server) des Zielsystems.</p>
        <div>
            <h3>Warum auch Load Balancer?</h3>
            Oft läuft das Zielsystem hinter einem Load Balancer für Hochverfügbarkeit.
        </div>
        <div>
            <h3>Reihenfolge der Auswahl:</h3>
            <ol>
    ...
    <div data-tooltip-id="interface-notes">
        <h2>Anmerkungen / Besonderheiten</h2>
        ...
        <div>
            <h3>Beispiel:</h3>
            "HL7 v2.5 ADT-Messages. Mapping: PID-8 Geschlecht: M→1, W→2, U→3. Keine Wiederholung bei Fehler - manuelle Nachbearbeitung nötig. Wartung: Jeden Sonntag 02:00-04:00. Ansprechpartner Labor: Dr. Schmidt (Tel. 1234)"
        </div>
