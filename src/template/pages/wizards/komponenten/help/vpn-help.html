<div class="tooltip-definitions" style="display: none;">
    <div data-tooltip-id="vpn-name">
        ...
        <div>
            ...
            Virtual Private Network - ein verschlüsselter Tunnel durch unsichere Netzwerke (meist Internet).
        </div>
        <div>
    ...
    <div data-tooltip-id="vpn-software">
        <h2>VPN-Software / Lösung</h2>
        <p>Welche VPN-Technologie wird verwendet?</p>
        <div>
            <h3>VPN-Lösungen erklärt:</h3>
            <ul>
    ...
    <div data-tooltip-id="vpn-auth">
        <h2>Authentifizierungs-Methode</h2>
        <p>Wie authentifizieren sich Benutzer beim VPN?</p>
        <div>
            <h3>Auth-Methoden erklärt:</h3>
            <ul>
    ...
    <div data-tooltip-id="vpn-compliance-check">
        <h2>Endpoint Compliance Check (Posture Check)</h2>
        <p>Prüfung des Geräts vor VPN-Zugang.</p>
        <div>
            <h3>Was ist Posture Check?</h3>
            VPN prüft Sicherheits-Zustand des Clients bevor Zugang gewährt wird.
        </div>
        <div>
        ...
        <div>
            <h3>Vorteil:</h3>
            Nur sichere Geräte im Firmennetz
        </div>
        <div>
            <h3>Nachteil:</h3>
            Mehr Verwaltungsaufwand, User-Frustration wenn abgelehnt
        </div>
        <em>Compliance Check = wichtige Sicherheits-Schicht, aber braucht gute Kommunikation!</em>
    </div>

    <div data-tooltip-id="vpn-kill-switch">
        <h2>Kill Switch / Drop-on-Disconnect</h2>
        <p>Blockiert Internet wenn VPN abbricht.</p>
        <div>
            <h3>Was ist Kill Switch?</h3>
            Wenn VPN-Verbindung abbricht → Internet wird sofort blockiert (kein "ungeschütztes Surfen").
        </div>
        <div>
            <h3>Das Problem ohne Kill Switch:</h3>
            <ol>
        ...
        <div>
            <h3>Mit Kill Switch:</h3>
            Internet wird sofort blockiert → Mitarbeiter merkt Problem → verbindet VPN neu
        </div>
        <div>
            <h3>Nachteil:</h3>
            Bei VPN-Problemen = kein Internet (Frustration)
        </div>
    ...
    <div data-tooltip-id="vpn-always-on">
        ...
        <div>
            <h3>Was ist Always-On?</h3>
            VPN startet automatisch beim Booten und bleibt immer verbunden.
        </div>
        <div>
            <h3>Vorteile:</h3>
            <ul>
    ...
    <div data-tooltip-id="vpn-ha">
        ...
        <div>
            <h3>Failover-Zeit:</h3>
            Wie lange dauert Umschaltung? (meist 30 Sekunden - 2 Minuten)
        </div>
    ...
    <div data-tooltip-id="vpn-logging">
        ...
        <div>
            <h3>Was sollte geloggt werden:</h3>
            <ul>
        ...
        <div>
            ...
            Logs an zentrales SIEM senden für Security-Monitoring
        </div>
        <div>
            <h3>Datenschutz:</h3>
            User haben Recht zu wissen was geloggt wird - Betriebsrat einbeziehen!
        </div>
        <em>Logging ist wichtig für Security, aber Datenschutz beachten!</em>
    </div>

    <div data-tooltip-id="vpn-notes">
        <h2>Notizen / VPN-Besonderheiten</h2>
