<div class="tooltip-definitions" style="display: none;">
    <div data-tooltip-id="commserver-name">
        <h2>Name des Kommunikationsservers</h2>
        <p>Ein eindeutiger Name für Ihren Kommunikationsserver.</p>
        <div>
            <h3>Was ist ein Kommunikationsserver?</h3>
            Eine zentrale Software-Plattform (auch Interface Engine genannt), die Nachrichten zwischen verschiedenen medizinischen Systemen vermittelt, übersetzt und routet.
        </div>
        <div>
            <h3>Warum wichtig im Krankenhaus?</h3>
            <ul>
    ...
    <div data-tooltip-id="commserver-vendor">
        ...
        <div>
            <h3>Wichtig für:</h3>
            Support-Verträge, Lizenzierung, Update-Planung
        </div>
    </div>
    ...
    <div data-tooltip-id="commserver-os">
        ...
        <div>
            <h3>Trend:</h3>
            Containerisierung (Docker/Kubernetes) - einfachere Verwaltung und Skalierung
        </div>
    </div>

    <div data-tooltip-id="commserver-admin-port">
        <h2>Web-Management-Port</h2>
        <p>Der Port für die Web-Administrationsoberfläche.</p>
        <div>
            <h3>Typische Ports:</h3>
            <ul>
        ...
        <div>
            <h3>Wichtig:</h3>
            Port sollte nur für Admins erreichbar sein (Firewall!)
        </div>
    ...
    <div data-tooltip-id="commserver-environment">
        ...
        <div>
            <h3>Best Practice:</h3>
            NIEMALS direkt in Produktion entwickeln - erst Test, dann Prod!
        </div>
    </div>

    <div data-tooltip-id="commserver-protocols">
        <h2>Protokoll-Support</h2>
    ...
    <div data-tooltip-id="commserver-channel-count">
        <h2>Anzahl aktiver Channels/Routen</h2>
        <p>Wie viele Schnittstellen (Channels) sind konfiguriert?</p>
        <div>
            <h3>Was ist ein Channel?</h3>
            Eine einzelne konfigurierte Schnittstelle - z.B. "ADT-Feed von KIS zu Labor"
        </div>
        <div>
            <h3>Typische Größenordnungen:</h3>
            <ul>
        ...
        <div>
            <h3>Warum zählen?</h3>
            Kapazitätsplanung, Performance-Überwachung, Lizenzierung
        </div>
    </div>

    <div data-tooltip-id="commserver-throughput">
        <h2>Nachrichtendurchsatz</h2>
        <p>Wie viele Nachrichten werden pro Tag verarbeitet?</p>
        <div>
            <h3>Warum wichtig?</h3>
            Performance-Planung, Kapazitäts-Dimensionierung
        </div>
        <div>
            <h3>Richtwerte:</h3>
            <ul>
    ...
    <div data-tooltip-id="commserver-ha">
        <h2>Hochverfügbarkeits-Konfiguration (HA/Cluster)</h2>
        <p>Läuft die Interface Engine redundant?</p>
        <div>
            <h3>Warum HA wichtig ist:</h3>
            Interface Engine ist meist kritischstes System - Ausfall = keine Datenflüsse!
        </div>
        <div>
            <h3>HA-Vorteile:</h3>
            <ul>
    ...
    <div data-tooltip-id="commserver-monitoring">
        ...
        <div>
            ...
            Interface Engine-Ausfall = Betriebsausfall!
        </div>
        <div>
            <h3>Monitoring-Optionen:</h3>
            <ul>
    ...
    <div data-tooltip-id="commserver-log-retention">
        ...
        <div>
            <h3>Problem:</h3>
            Interface Engine Logs können RIESIG werden (GB pro Tag!)
        </div>
    ...
    <div data-tooltip-id="commserver-siem">
        ...
        <div>
            <h3>Was ist SIEM?</h3>
            Security Information and Event Management - zentrale Log-Sammlung und Sicherheitsüberwachung
        </div>
        <div>
            <h3>Warum SIEM für Interface Engine?</h3>
            <ul>
        ...
        <div>
            <h3>Typische SIEM-Systeme:</h3>
            Splunk, QRadar, Elastic, Microsoft Sentinel
        </div>
    ...
    <div data-tooltip-id="commserver-tls">
        <h2>TLS/SSL für Admin-Zugriff</h2>
        <p>Ist die Admin-Oberfläche verschlüsselt?</p>
        <div>
            <h3>Warum TLS wichtig:</h3>
            <ul>
        ...
        <div>
            <h3>Ja, TLS aktiviert:</h3>
            HTTPS (Port 8443, 443) - <em>Empfohlen!</em>
        </div>
        <div>
            <h3>Nein:</h3>
            HTTP (Port 8080) - <em>Nur für Test-Umgebungen!</em>
        </div>
        <em>Produktiv-Systeme MÜSSEN TLS haben!</em>
    </div>

    <div data-tooltip-id="commserver-access">
        <h2>Zugriffsberechtigung</h2>
        <p>Wer darf auf den Server zugreifen?</p>
        <div>
            <h3>Typische Rollen:</h3>
            <ul>
        ...
        <div>
            ...
            Nur die wirklich nötigen Personen, nur die nötigen Rechte
        </div>
    ...
    <div data-tooltip-id="commserver-maintenance">
        ...
        <div>
            <h3>Warum Wartungsfenster wichtig:</h3>
            <ul>
    ...
    <div data-tooltip-id="commserver-last-update">
        ...
        <div>
            <h3>Empfohlener Update-Rhythmus:</h3>
            <ul>
    ...
    <div data-tooltip-id="commserver-support">
        ...
        <div>
            <h3>Beispiel:</h3>
            "interface-support@example.com, Rufbereitschaft: +49-xxx-xxx (24/7)"
        </div>
    ...
    <div data-tooltip-id="commserver-notes">
        ...
        <div>
            <h3>Beispiel:</h3>
            "Upgrade auf v4.5 geplant für Q2/2024. Bekanntes Problem: Channel 'Lab-Results' muss nach Neustart manuell gestartet werden. Java Heap Size auf 8GB erhöht wegen hoher Last."
        </div>
