<div class="tooltip-definitions" style="display: none;">
    <div data-tooltip-id="siem-name">
        <strong>SIEM-System Name</strong>
        <p>Ein eindeutiger Name für Ihr SIEM-System.</p>
        <p><strong>Was ist ein SIEM?</strong> Security Information and Event Management - das "Nervenzentrum" Ihrer IT-Sicherheit!</p>
        <p><strong>Warum SIEM essentiell ist:</strong></p>
        <ul>
    ...
    <div data-tooltip-id="siem-software">
        <strong>SIEM-Software</strong>
        <p>Welche SIEM-Plattform wird verwendet?</p>
        <p><strong>SIEM-Kategorien:</strong></p>
        <ul>
    ...
    <div data-tooltip-id="siem-license">
        ...
        <p><strong>Lizenz-Modelle erklärt:</strong></p>
        <ul>
    ...
    <div data-tooltip-id="siem-deployment">
        <strong>Deployment-Typ</strong>
        <p>Wo läuft das SIEM?</p>
        <p><strong>Deployment-Optionen:</strong></p>
        <ul>
    ...
    <div data-tooltip-id="siem-eps">
        ...
        <p><strong>Was ist EPS?</strong> Die "Geschwindigkeit" Ihres SIEMs - wie viele Events können pro Sekunde verarbeitet werden?</p>
        <p><strong>Typische EPS-Werte:</strong></p>
        <ul>
        ...
        <p><strong>Was beeinflusst EPS:</strong></p>
        <ul>
        ...
        <p><strong>Wichtig:</strong> EPS-Lizenz groß genug dimensionieren - sonst werden Logs gedrosselt = blind für Angriffe!</p>
        <em>Faustformel: 10-50 EPS pro aktivem Gerät</em>
    </div>

    <div data-tooltip-id="siem-logsources">
        <strong>Log-Quellen Typen</strong>
        <p>Welche Arten von Systemen senden Logs an das SIEM?</p>
        <p><strong>Wichtige Log-Quellen:</strong></p>
        <ul>
        ...
        <p><strong>Je mehr Quellen, desto besser die Sichtbarkeit!</strong></p>
        <em>Minimum: Firewall + AD + Server</em>
    </div>

    <div data-tooltip-id="siem-usecases">
        <strong>Use Cases / Detection Rules</strong>
        <p>Konfigurierte Erkennungsregeln für Sicherheitsvorfälle.</p>
        <p><strong>Was sind Use Cases?</strong> Regeln die sagen: "Wenn X passiert, dann Alert auslösen" - wie Rauchmelder für IT-Angriffe.</p>
        ...
        <p><strong>Typische Anzahl:</strong></p>
        <ul>
    ...
    <div data-tooltip-id="siem-ueba">
        <strong>Machine Learning / UEBA</strong>
        <p>Automatische Erkennung anomalen Verhaltens durch KI.</p>
        <p><strong>Was ist UEBA?</strong> User and Entity Behavior Analytics - lernt "normales" Verhalten und erkennt Abweichungen.</p>
        <p><strong>Was UEBA kann:</strong></p>
        <ul>
        ...
        <p><strong>Herausforderung:</strong> Braucht Zeit zum Lernen (2-4 Wochen) und kann False Positives erzeugen</p>
    ...
    <div data-tooltip-id="siem-threatintel">
        ...
        <p><strong>Was ist Threat Intelligence?</strong> Wissen über aktuelle Bedrohungen - "Steckbriefe" von Angreifern, Malware, C&C-Servern.</p>
        <p><strong>Threat Intel Quellen:</strong></p>
        <ul>
        ...
        <p><strong>Was wird gematcht:</strong></p>
        <ul>
        ...
        <p><strong>Beispiel:</strong> Firewall-Log zeigt Verbindung zu IP 1.2.3.4 → SIEM matcht gegen Threat Intel → IP ist bekannter C&C-Server → High-Priority Alert!</p>
    ...
    <div data-tooltip-id="siem-mitre">
        ...
        <p><strong>Was ist MITRE ATT&CK?</strong> Eine "Enzyklopädie" aller bekannten Angriffstechniken - wie ein "Playbook" von Hackern.</p>
        ...
        <p><strong>Warum im SIEM wichtig:</strong></p>
        <ul>
        ...
        <p><strong>MITRE ATT&CK Navigator:</strong> Tool zur Visualisierung der Abdeckung</p>
    ...
    <div data-tooltip-id="siem-soar">
        ...
        <p><strong>Was ist SOAR?</strong> Automatisierung von Incident-Response-Prozessen - "Roboter für SOC-Analysts".</p>
        <p><strong>Was SOAR macht:</strong></p>
        <ul>
        ...
        <p><strong>Beispiel-Workflow (automatisch):</strong></p>
        <ol>
        ...
        <p><strong>SOAR-Plattformen:</strong></p>
        <ul>
        ...
        <p><strong>Vorteil:</strong> Reaktionszeit von Stunden auf Sekunden reduzieren!</p>
        <em>SOAR = Force Multiplier für kleine SOC-Teams</em>
    </div>

    <div data-tooltip-id="siem-retention">
        <strong>Log-Retention (Aufbewahrung)</strong>
        ...
        <p><strong>Typische Retention-Strategie:</strong></p>
        <ul>
        ...
        <p><strong>Storage-Bedarf:</strong> Bei 100 GB/Tag:</p>
        <ul>
            <li>90 Tage = 9 TB</li>
    ...
    <div data-tooltip-id="siem-alerting">
        <strong>Alerting & Notification</strong>
        ...
        <p><strong>Alert-Fatigue Problem:</strong></p>
        <ul>
    ...
    <div data-tooltip-id="siem-soc">
        <strong>SOC (Security Operations Center)</strong>
        <p>Das Team, das das SIEM überwacht.</p>
        <p><strong>Was ist ein SOC?</strong> Das "Kontrollzentrum" für IT-Sicherheit - Analysten überwachen SIEM 24/7.</p>
        <p><strong>SOC-Typen:</strong></p>
        <ul>
        ...
        <p><strong>SOC-Betriebszeiten:</strong></p>
        <ul>
    ...
    <div data-tooltip-id="siem-notes">
        <strong>Notizen / SIEM-Besonderheiten</strong>
